...
- **Wearable Set Data Fixes:** The `data/wearableSets.json` file includes corrections for known-incorrect set data. Example: Quickswap Dragon set corrected to BRS +3, AGG +1, SPK +1 (was incorrectly showing NRG +3).
