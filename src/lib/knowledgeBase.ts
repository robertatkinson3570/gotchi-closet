...
export const KB_SECTIONS: KBSection[] = [
  ...
  },
  {
    ...
    emoji: "🫧",
    blurb: "Your gotchi can talk to you.",
    items: [
      { heading: "What it is", body: "Pick one of your gotchis and it becomes a floating companion that chats with you in a voice derived from its own traits, age, XP and kinship. It knows itself (your data) and Aavegotchi lore, and helps you use this app. It's talk-only — it never signs transactions for you.", tags: ["companion", "chat", "talk", "assistant", "ai", "mascot"] },
      { heading: "Free & premium", body: "The companion is free for everyone (free hosted model + in-character fallback). A premium tier with a stronger model can be unlocked with a GHST payment on Base.", tags: ["companion premium", "free", "premium", "ghst"] },
    ],
  },
  {
    id: "aavegotchi-101",
