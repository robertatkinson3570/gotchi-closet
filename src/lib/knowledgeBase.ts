...
export const KB_SECTIONS: KBSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { heading: "The Soul Certificate", body: "Your bond is surfaced as a shareable Soul Certificate — a beautiful card showing your gotchi's Soul Level, soul age, kinship streak, memories, and its past-life echoes. It's free for everyone, and you can download it to share. The certificate only proves depth; the value accrues from the bond itself over time.", tags: ["certificate", "soul certificate", "card", "share", "download", "soul level", "memories", "streak", "free"] },
      { heading: "Verify (public proof)", body: "Anyone can open a gotchi's public Verify page to confirm its sealed soul on-chain — it shows the soul level/depth alongside the SoulSeal contract and the attestor signature, so the claim is tamper-evident and independently checkable.", tags: ["verify", "proof", "public", "contract", "attestor", "signature", "on-chain", "tamper"] },
